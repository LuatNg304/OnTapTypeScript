...
module.exports = (env) => {
  ...
  return {
    ...
    output: {
      ...
      clean: true, // don dep cac file cu moi lan build(css, js  )
              ...
              presets: [
                [
                  "@babel/preset-env",
                  {
                    ...
                    useBuiltIns: "entry", // Chỉ bao gồm polyfill những gì được sử dụng trong code
                    corejs: "3.47.0", // nên quy định verson core-js để babel-preset-env nó hoạt động tối ưu
                  },
                ],
              ],
            },
